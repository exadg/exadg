        ...
        ++line, ++line_iterator)
    {
          ...
          ++quantity)
      {
        ...
        AssertThrow(
          ...
          ExcMessage(
            "Averaging type for QuantityStatistics is not compatible with this type of line "
        ...
        AssertThrow(direction == averaging_direction,
                    ExcMessage(
                      "Averaging directions for different lines/quantities do not match."));
      }
            ...
            ++quantity)
        {
          ...
          if((*quantity)->type == QuantityType::ReynoldsStresses)
          {
            ...
            for(unsigned int i = 0; i < dim; ++i)
            {
              ...
              {
                f << std::setw(precision + 8) << std::left
                  << "u_" + Utilities::int_to_string(i + 1) + "u_" +
