...
#ifndef INCLUDE_INCOMPRESSIBLE_NAVIER_STOKES_INFRASTRUCTURE_FE_EVALUATION_WRAPPER_H_
#define INCLUDE_INCOMPRESSIBLE_NAVIER_STOKES_INFRASTRUCTURE_FE_EVALUATION_WRAPPER_H_
...
//
// public:
//  FEEvaluationWrapper(const MatrixFree<dim, Number> & matrix_free,
...
//        matrix_free,
//        fe_no,
//        find_quadrature_slot(matrix_free, quad_no)),
//      fe_param(in_fe_param)
//  {
//    std_dofs_per_cell =
//      FEEvaluation<dim, fe_degree, n_q_points_1d, n_components_, Number>::dofs_per_cell;
//  }
//
//  // read and write access functions
//  // see definition of begin_dof_values
//  VectorizedArray<Number>
//  read_cellwise_dof_value(unsigned int j)
//  {
//    return FEEvaluation<dim, fe_degree, n_q_points_1d, n_components_, Number>::begin_dof_values()
//      [j];
//  }
//
//  void
//  write_cellwise_dof_value(unsigned int j, Number value, unsigned int v)
//  {
//    FEEvaluation<dim, fe_degree, n_q_points_1d, n_components_, Number>::begin_dof_values()[j][v] =
//      value;
//  }
//
//  void
//  write_cellwise_dof_value(unsigned int j, VectorizedArray<Number> value)
//  {
//    FEEvaluation<dim, fe_degree, n_q_points_1d, n_components_, Number>::begin_dof_values()[j] =
//      value;
//    return;
//  }
//
...
//
//  using FEEvaluation<dim, fe_degree, n_q_points_1d, n_components_, Number>::
//    distribute_local_to_global;
//
//  using FEEvaluation<dim, fe_degree, n_q_points_1d, n_components_, Number>::set_dof_values;
//
//  Tensor<2, dim, VectorizedArray<Number>>
//  make_symmetric(const Tensor<2, dim, VectorizedArray<Number>> & grad) const
//  {
...
//  make_symmetric(const Tensor<1, dim, VectorizedArray<Number>> & grad) const
//  {
...
//
//  bool
//  component_enriched(unsigned int)
//  {
//    return false;
//  }
//
...
//         typename Number     = double,
//         bool is_enriched    = false>
// class FEEvaluationWrapperPressure : public FEEvaluationWrapper<dim,
//                                                               fe_degree,
//                                                               fe_degree_xwall,
//                                                               n_q_points_1d,
//                                                               n_components_,
...
//{
// public:
//  FEEvaluationWrapperPressure(const MatrixFree<dim, Number> & matrix_free,
//                              const FEParameters<dim> *       in_fe_param,
//                              const unsigned int              fe_no   = 0,
//                              const int                       quad_no = -1)
...
//                          n_components_,
//                          Number,
//                          is_enriched>(matrix_free, in_fe_param, fe_no, quad_no)
//  {
//  }
//};
//
...
//  : public FEFaceEvaluation<dim, fe_degree, n_q_points_1d, n_components_, Number>
//{
// private:
//  static unsigned int
//  find_quadrature_slot(const MatrixFree<dim, Number> & mf, const int quad_no)
...
//  {
//    std_dofs_per_cell =
//      FEFaceEvaluation<dim, fe_degree, n_q_points_1d, n_components_, Number>::dofs_per_cell;
//  }
//
//  // read and write access functions
//  // see definition of begin_dof_values
...
//  read_cellwise_dof_value(unsigned int j)
//  {
//    return FEFaceEvaluation<dim, fe_degree, n_q_points_1d, n_components_, Number>::
//      begin_dof_values()[j];
//  }
//
//  void
//  write_cellwise_dof_value(unsigned int j, Number value, unsigned int v)
//  {
//    FEFaceEvaluation<dim, fe_degree, n_q_points_1d, n_components_, Number>::begin_dof_values()
//      [j][v] = value;
//  }
//
//  void
//  write_cellwise_dof_value(unsigned int j, VectorizedArray<Number> value)
//  {
//    FEFaceEvaluation<dim, fe_degree, n_q_points_1d, n_components_, Number>::begin_dof_values()[j]
//    =
//      value;
//    return;
//  }
...
//
//  using FEFaceEvaluation<dim, fe_degree, n_q_points_1d, n_components_, Number>::
//    distribute_local_to_global;
//
//  Tensor<2, dim, VectorizedArray<Number>>
//  make_symmetric(const Tensor<2, dim, VectorizedArray<Number>> & grad) const
...
//         typename Number     = double,
//         bool is_enriched    = false>
// class FEFaceEvaluationWrapperPressure : public FEFaceEvaluationWrapper<dim,
//                                                                       fe_degree,
//                                                                       fe_degree_xwall,
//                                                                       n_q_points_1d,
//                                                                       n_components_,
...
//                              n_components_,
//                              Number,
//                              is_enriched>(matrix_free, in_fe_param, is_left_face, fe_no, quad_no)
//  {
//  }
//};
//
...
//    // use non-linear quadrature rule for now for all terms... small speed-up possible through
//    // better choice of standard quadrature rule (via additional template argument)
//    fe_eval.push_back(
//      dynamic_cast<FEEvaluationAccess<dim, n_components_, Number, false> *>(&fe_eval_q0));
//    fe_eval.push_back(
//      dynamic_cast<FEEvaluationAccess<dim, n_components_, Number, false> *>(&fe_eval_q1));
//
//    fe_eval_xwall.push_back(
//      dynamic_cast<FEEvaluationAccess<dim, n_components_, Number, false> *>(&fe_eval_xwall_q0));
//    fe_eval_xwall.push_back(
//      dynamic_cast<FEEvaluationAccess<dim, n_components_, Number, false> *>(&fe_eval_xwall_q1));
//
//    fe_eval_tauw.push_back(
//      dynamic_cast<FEEvaluationAccess<dim, 1, Number, false> *>(&fe_eval_tauw_q0));
//    fe_eval_tauw.push_back(
//      dynamic_cast<FEEvaluationAccess<dim, 1, Number, false> *>(&fe_eval_tauw_q1));
//  };
//
...
//
//  virtual void
//  reinit(const unsigned int cell, const bool do_not_use_precomputed_enrichment = false)
//  {
//    enriched = false;
...
//      if(fe_param->enrichment == nullptr || (*fe_param->enrichment).size() - 1 < cell ||
//         do_not_use_precomputed_enrichment)
//      {
...
//              AssertThrow(fe_eval_tauw[quad_type]->get_value(q)[v] > 1.0e-9,
//                          ExcMessage("Wall shear stress has to be above zero for Spalding's
//                          law"));
//          }
//
...
//        }
//        spalding.reinit(
//          cell_wdist, cell_tauw, cell_gradwdist, cell_gradtauw, n_q_points, enriched_components);
//      }
//      else
//      {
...
//        spalding.reinit((*fe_param->enrichment)[cell],
//                        (*fe_param->enrichment_gradient)[cell],
//                        n_q_points);
//      }
...
//    //          {
//    //            std::cout << std::abs(spalding.enrichment_gradient(q)[i][v]) << " enriched " <<
//    //            enriched << " component_enriched  " << enriched_components[v]<< std::endl;
...
//         AlignedVector<VectorizedArray<Number>> &                 enrichment_cell,
...
//
//  void
//  fill_wdist_and_tauw(unsigned int                             cell,
...
//
//  VectorizedArray<Number> *
//  begin_dof_values() DEAL_II_DEPRECATED
//  {
...
//    //            AssertThrow((fe_eval_xwall[quad_type]->begin_dof_values()[i][v] <
//    //            1e-9),ExcMessage("out"));
//    //    }
//  }
//
//  void
//  evaluate(VectorizedArray<Number> * src,
...
//
//  void
//  evaluate(const bool evaluate_val, const bool evaluate_grad, const bool evaluate_hess = false)
//  {
...
//        for(unsigned int q = 0; q < n_q_points; ++q)
//        {
//          value_type finalvalue  = fe_eval_xwall[quad_type]->get_value(q) *
//          spalding.enrichment(q); value_type submitvalue = value_type();
//          // delete enrichment part where not needed
//          // this is essential, code won't work otherwise
//          for(unsigned int v = 0; v < VectorizedArray<Number>::n_array_elements; ++v)
//            if(enriched_components[v])
...
//      {
//        grad[j][i] +=
//          fe_eval_xwall[quad_type]->get_value(q)[j] * spalding.enrichment_gradient(q)[i];
//      }
//    }
//  }
//
...
//
//  value_type
//  get_value(const unsigned int q_point)
//  {
//    if(enriched)
...
//
//  gradient_type
//  get_gradient(const unsigned int q_point)
//  {
//    if(enriched)
...
//
//  gradient_type
//  get_symmetric_gradient(const unsigned int q_point)
//  {
...
//
//  void
//  integrate(const bool integrate_val, const bool integrate_grad, VectorizedArray<Number> * dst)
//  {
...
//      // this function is quite nasty because deal.ii doesn't seem to be made for enrichments
//      // the scalar product of the second part of the gradient is computed directly and added to
//      the
//      // value
//      if(integrate_grad)
//      {
...
//  quadrature_point(unsigned int q)
//  {
//    if(quad_type == 0)
...
//      {
//        case 1:
//          AssertThrow(false, ExcMessage("Computing the curl in 1d is not a useful operation"));
//          break;
//        case 2:
...
//      else
//      {
//        return fe_eval_xwall[quad_type]->begin_dof_values()[j - std_dofs_per_cell *
//        n_components_];
//      }
//    }
//    // else
...
//  // node/component wise
//  VectorizedArray<Number>
//  read_cellwise_dof_value(unsigned int j, unsigned int comp)
//  {
//    if(enriched)
//    {
...
//      else
//        return fe_eval_xwall[quad_type]
//          ->begin_dof_values()[j - std_dofs_per_cell + comp * (dofs_per_cell -
//          std_dofs_per_cell)];
//    }
//    // else
//    return fe_eval[quad_type]->begin_dof_values()[j];
...
//      else
//        fe_eval_xwall[quad_type]->begin_dof_values()[j - std_dofs_per_cell * n_components_][v] =
//          value;
//    }
//    else
//      fe_eval[quad_type]->begin_dof_values()[j][v] = value;
...
//
//  void
//  write_cellwise_dof_value(unsigned int j, unsigned int comp, Number value, unsigned int v)
//  {
//    if(enriched)
//    {
//      if(j < std_dofs_per_cell)
...
//      else
//        fe_eval_xwall[quad_type]
//          ->begin_dof_values()[j - std_dofs_per_cell + comp * (dofs_per_cell - std_dofs_per_cell)]
//                              [v] = value;
//    }
//    else
//      fe_eval[quad_type]->begin_dof_values()[j][v] = value;
...
//      else
//        fe_eval_xwall[quad_type]->begin_dof_values()[j - std_dofs_per_cell * n_components_] =
//        value;
//    }
//    else
//      fe_eval[quad_type]->begin_dof_values()[j] = value;
...
//
//  bool
//  component_enriched(unsigned int v)
//  {
//    if(not enriched)
//      return false;
//    // else
...
//  void
//  fe_eval_evaluate(bool evaluate_val, bool evaluate_grad)
//  {
//    if(quad_type == 0)
//    {
...
//
//  void
//  fe_eval_xwall_evaluate(bool evaluate_val, bool evaluate_grad)
//  {
...
//
//  void
//  fe_eval_tauw_evaluate(bool evaluate_val, bool evaluate_grad)
//  {
//    if(quad_type == 0)
//    {
...
//
//  void
//  fe_eval_integrate(bool integrate_val, bool integrate_grad)
//  {
//    if(quad_type == 0)
//    {
...
//
//  void
//  fe_eval_xwall_integrate(bool integrate_val, bool integrate_grad)
//  {
//    Assert(enriched, ExcMessage("fe_eval_xwall not initialized"));
//    if(quad_type == 0)
//    {
...
//
//  void
//  add_array_component_to_value(VectorizedArray<Number> &       val,
//                               const VectorizedArray<Number> & toadd,
//                               unsigned int                    v)
//  {
//    val[v] += toadd[v];
//  }
//
//  void add_array_component_to_value(Tensor<1, n_components_, VectorizedArray<Number>> &       val,
//                                    const Tensor<1, n_components_, VectorizedArray<Number>> &
//                                    toadd, unsigned int v)
//  {
//    for(unsigned int d = 0; d < n_components_; d++)
//      val[d][v] += toadd[d][v];
//  }
//
//  void add_array_component_to_gradient(Tensor<2, dim, VectorizedArray<Number>> &       grad,
//                                       const Tensor<2, dim, VectorizedArray<Number>> & toadd,
//                                       unsigned int                                    v)
//  {
...
//  }
//
//  void add_array_component_to_gradient(Tensor<1, dim, VectorizedArray<Number>> &       grad,
//                                       const Tensor<1, dim, VectorizedArray<Number>> & toadd,
//                                       unsigned int                                    v)
//  {
//    for(unsigned int d = 0; d < n_components_; d++)
//      grad[d][v] += toadd[d][v];
//  }
//
//  void grad_enr_to_val(AlignedVector<Tensor<1, dim, VectorizedArray<Number>>> & tmp_values,
//                       AlignedVector<Tensor<2, dim, VectorizedArray<Number>>> & gradient)
//  {
//    for(unsigned int q = 0; q < n_q_points; ++q)
//    {
...
//
//  void
//  grad_enr_to_val(AlignedVector<VectorizedArray<Number>> &                 tmp_values,
//                  AlignedVector<Tensor<1, dim, VectorizedArray<Number>>> & gradient)
//  {
//    for(unsigned int q = 0; q < n_q_points; ++q)
//    {
//      for(int i = 0; i < dim; ++i) // dim
...
//  FEEvaluation<dim, fe_degree_xwall, fe_degree + (fe_degree + 2) / 2, n_components_, Number>
//                                                                           fe_eval_xwall_q0;
...
//  // this is the maximum value of dofs per cell occurring and can be used e.g. to define vector
//  // lengths
//  static const unsigned int tensor_dofs_per_cell =
//    Utilities::pow(fe_degree + 1, dim) + Utilities::pow(fe_degree_xwall + 1, dim);
...
//         int n_components_,
//         typename Number>
// class FEEvaluationWrapperPressure<dim,
//                                  fe_degree,
//                                  fe_degree_xwall,
//                                  n_q_points_1d,
//                                  n_components_,
//                                  Number,
//                                  true> : public FEEvaluationWrapper<dim,
//                                                                     fe_degree,
//                                                                     fe_degree_xwall,
//                                                                     n_q_points_1d,
//                                                                     n_components_,
...
//                          n_components_,
//                          Number,
//                          true>(matrix_free, in_fe_param, fe_no){};
//
//  void
//  reinit(const unsigned int cell, const bool = false)
//  {
//    this->enriched = false;
...
//      //            std::cout << ((dcell->center()[1] > (1.0-MAX_WDIST_XWALL)) ||
//      //            (dcell->center()[1] <(-1.0 + MAX_WDIST_XWALL))) << std::endl;
...
//         int n_components_,
//         typename Number>
// class FEFaceEvaluationWrapper<dim,
//                              fe_degree,
//                              fe_degree_xwall,
//                              n_q_points_1d,
//                              n_components_,
...
//    fe_eval.push_back(
//      dynamic_cast<FEEvaluationAccess<dim, n_components_, Number, true> *>(&fe_eval_q0));
//    fe_eval.push_back(
//      dynamic_cast<FEEvaluationAccess<dim, n_components_, Number, true> *>(&fe_eval_q1));
//
//    fe_eval_xwall.push_back(
//      dynamic_cast<FEEvaluationAccess<dim, n_components_, Number, true> *>(&fe_eval_xwall_q0));
//    fe_eval_xwall.push_back(
//      dynamic_cast<FEEvaluationAccess<dim, n_components_, Number, true> *>(&fe_eval_xwall_q1));
//
//    fe_eval_tauw.push_back(
//      dynamic_cast<FEEvaluationAccess<dim, 1, Number, true> *>(&fe_eval_tauw_q0));
//    fe_eval_tauw.push_back(
//      dynamic_cast<FEEvaluationAccess<dim, 1, Number, true> *>(&fe_eval_tauw_q1));
//
...
//                              data.faces.at(f).left_cell[v] != numbers::invalid_unsigned_int;
//          ++v)
//      {
...
//      }
//      // there may be interface elements that need a high-order quadrature despite that they are
//      not
//      // enriched in that case, the other element is enriched
//      for(unsigned int v = 0; v < VectorizedArray<Number>::n_array_elements &&
//                              data.faces.at(f).right_cell[v] != numbers::invalid_unsigned_int;
//          ++v)
//      {
//        typename DoFHandler<dim>::cell_iterator dcell = data.get_cell_iterator(
...
//        }
//        spalding.reinit(
//          face_wdist, face_tauw, face_gradwdist, face_gradtauw, n_q_points, enriched_components);
//      }
//      dofs_per_cell = fe_eval_q0.dofs_per_cell + fe_eval_xwall_q0.dofs_per_cell;
//    }
//    else
...
//
//  void
//  fill_wdist_and_tauw(unsigned int                             face,
//                      AlignedVector<VectorizedArray<Number>> & wdist,
//                      AlignedVector<VectorizedArray<Number>> & tauw)
//  {
...
//    if(enriched)
//      return fe_eval[quad_type]->get_value(q_point) +
//             values[q_point]; // fe_eval[quad_type]->get_value(q_point) + values[q_point];
//    // else
//    return fe_eval[quad_type]->get_value(q_point);
//  }
//
...
//
//  VectorizedArray<Number>
//  get_normal_volume_fraction()
//  {
//    return fe_eval[quad_type]->get_normal_volume_fraction();
//  }
//
//  VectorizedArray<Number>
//  read_cell_data(const AlignedVector<VectorizedArray<Number>> & cell_data)
//  {
...
//      {
//        grad_out[comp] =
//          gradients[q_point][comp][0] * fe_eval[quad_type]->get_normal_vector(q_point)[0];
//        for(unsigned int d = 1; d < dim; ++d)
//          grad_out[comp] +=
//            gradients[q_point][comp][d] * fe_eval[quad_type]->get_normal_vector(q_point)[d];
//      }
...
//
//  VectorizedArray<Number>
//  get_normal_gradient(const unsigned int q_point, bool) const
//  {
//    if(enriched)
//    {
...
//            if(enriched_components[v])
//            {
//              gradients[q][comp][d][v] =
//                grad_in[comp][v] * fe_eval[quad_type]->get_normal_vector(q)[d][v];
//            }
//            else
...
//
//  void
//  submit_normal_gradient(const VectorizedArray<Number> grad_in, const unsigned int q)
//  {
//    fe_eval[quad_type]->submit_normal_gradient(grad_in, q);
//    if(enriched)
//    {
...
//          if(enriched_components[v])
//          {
//            gradients[q][d][v] = grad_in[v] * fe_eval[quad_type]->get_normal_vector(q)[d][v];
//          }
//          else
//            gradients[q][d][v] = 0.0;
//        }
...
//  const FEParameters<dim> *                                    fe_param;
//  SpaldingsLawEvaluation<dim, Number, VectorizedArray<Number>> spalding;
//  FEFaceEvaluation<dim, fe_degree, fe_degree + (fe_degree + 2) / 2, n_components_, Number>
//                                                                         fe_eval_q0;
...
//  FEFaceEvaluation<dim, fe_degree_xwall, fe_degree + (fe_degree + 2) / 2, n_components_, Number>
//                                                                               fe_eval_xwall_q0;
...
//         int n_components_,
//         typename Number>
// class FEFaceEvaluationWrapperPressure<dim,
//                                      fe_degree,
//                                      fe_degree_xwall,
//                                      n_q_points_1d,
//                                      n_components_,
//                                      Number,
//                                      true> : public FEFaceEvaluationWrapper<dim,
//                                                                             fe_degree,
//                                                                             fe_degree_xwall,
//                                                                             n_q_points_1d,
//                                                                             n_components_,
...
//                              n_components_,
//                              Number,
//                              true>(matrix_free, in_fe_param, is_left_face, fe_no){};
//
//  void
//  reinit(const unsigned int f)
//  {
...
//      // decide if we have an enriched element via the y component of the cell center
//      for(unsigned int v = 0; v < VectorizedArray<Number>::n_array_elements &&
//                              this->data.faces.at(f).left_cell[v] !=
...
//      // enriched in that case, the other element is enriched
//      for(unsigned int v = 0; v < VectorizedArray<Number>::n_array_elements &&
//                              this->data.faces.at(f).right_cell[v] !=
//                              numbers::invalid_unsigned_int;
//          ++v)
//      {
//        typename DoFHandler<dim>::cell_iterator dcell = this->data.get_cell_iterator(
