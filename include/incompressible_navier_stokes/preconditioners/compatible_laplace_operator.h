...
public:
              ...
              const unsigned int level)
  {
    ...
    CompatibleLaplaceOperatorData<dim> comp_laplace_operator_data = *static_cast<CompatibleLaplaceOperatorData<dim> *>(operator_data_in);
    ...
    GradientOperatorData<dim> gradient_operator_data = comp_laplace_operator_data.gradient_operator_data;
    own_gradient_operator_storage.initialize(own_matrix_free_storage,gradient_operator_data);

    // setup own divergence operator
    DivergenceOperatorData<dim> divergence_operator_data = comp_laplace_operator_data.divergence_operator_data;
  ...
  return new CompatibleLaplaceOperator<dim, fe_degree, fe_degree_p, fe_degree_xwall, xwall_quad_rule, Number>();
  }
