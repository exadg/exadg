...
{
/*
 * Multigrid preconditioner for velocity (reaction-)diffusion operator (Helmholtz operator) of the
 * incompressible Navier-Stokes equations.
 */
template<int dim, typename value_type, typename Operator, typename UnderlyingOperator>
class MyMultigridPreconditionerVelocityDiffusion
  : public MyMultigridPreconditionerDG<dim, value_type, Operator>
{
public:
...
private:
  /*
   * This function updates mg_matrices by updating scaling_factor_time_derivative_term. This is
   * necessary if adaptive time stepping is used where the scaling factor of the derivative term is
   * variable.
   */
  void
  update_mg_matrices(double const & scaling_factor_time_derivative_term)
  {
 ...
 */
template<int dim, typename value_type, typename Operator, typename UnderlyingOperator>
class MyMultigridPreconditionerVelocityConvectionDiffusion
  : public MyMultigridPreconditionerDG<dim, value_type, Operator>
{
public:
