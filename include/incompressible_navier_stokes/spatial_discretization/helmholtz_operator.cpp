...
#if DEGREE_1
    case 1:
      return new HelmholtzOperator<dim, 1, fe_degree_xwall, xwall_quad_rule, Number>();
#endif
#if DEGREE_2
    case 2:
      return new HelmholtzOperator<dim, 2, fe_degree_xwall, xwall_quad_rule, Number>();
#endif
#if DEGREE_3
    case 3:
      return new HelmholtzOperator<dim, 3, fe_degree_xwall, xwall_quad_rule, Number>();
#endif
#if DEGREE_4
    case 4:
      return new HelmholtzOperator<dim, 4, fe_degree_xwall, xwall_quad_rule, Number>();
#endif
#if DEGREE_5
    case 5:
      return new HelmholtzOperator<dim, 5, fe_degree_xwall, xwall_quad_rule, Number>();
#endif
#if DEGREE_6
    case 6:
      return new HelmholtzOperator<dim, 6, fe_degree_xwall, xwall_quad_rule, Number>();
#endif
#if DEGREE_7
    case 7:
      return new HelmholtzOperator<dim, 7, fe_degree_xwall, xwall_quad_rule, Number>();
#endif
#if DEGREE_8
    case 8:
      return new HelmholtzOperator<dim, 8, fe_degree_xwall, xwall_quad_rule, Number>();
#endif
#if DEGREE_9
    case 9:
      return new HelmholtzOperator<dim, 9, fe_degree_xwall, xwall_quad_rule, Number>();
#endif
    default:
