...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule, typename Number>
double HelmholtzOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule, Number>::
  get_wall_time() const
  {
    return wall_time;
  }
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule, typename Number>
void HelmholtzOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule, Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule, typename Number>
HelmholtzOperatorData<dim> const & HelmholtzOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule, Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule, typename Number>
MassMatrixOperatorData const & HelmholtzOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule, Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule, typename Number>
ViscousOperatorData<dim> const & HelmholtzOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule, Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule, typename Number>
types::global_dof_index HelmholtzOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule, Number>::
  m() const
  {
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule, typename Number>
Number HelmholtzOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule, Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule, typename Number>
MatrixFree<dim,Number> const & HelmholtzOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule, Number>::
  get_data() const
  {
    return *data;
  }
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule, typename Number>
unsigned int HelmholtzOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule, Number>::
  get_dof_index() const
  {
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule, typename Number>
MatrixOperatorBaseNew<dim, Number>* HelmholtzOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule, Number>::
