                                                    ...
                                                    types::boundary_id const & boundary_id) const
{
  ...
  for(unsigned int q = 0; q < integrator.n_q_points; ++q)
  {
    ...
    if(this->data.viscous_problem)
    {
      ...
      if (viscous_kernel->get_data().known_normal_vector==true)
        normal_gradient_p = calculate_exterior_normal_gradient(normal_gradient_m,
                                                              ...
                                                              this->data.bc,
                                                              this->time);
      else if (viscous_kernel->get_data().known_normal_vector==false)
        normal_gradient_p = calculate_exterior_normal_gradient_without_known_normal_vectors(normal_gradient_m,
                                                                        q,
                                                                        integrator,
                                                                        operator_type,
                                                                        boundary_type,
