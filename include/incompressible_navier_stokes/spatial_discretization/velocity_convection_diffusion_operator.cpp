...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
void VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
double VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
void VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::set_solution_linearization(parallel::distributed::Vector<Number> const &
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
parallel::distributed::Vector<Number> & VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
VelocityConvDiffOperatorData<dim> const & VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
HelmholtzOperatorData<dim> const VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
MassMatrixOperatorData const & VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
ConvectiveOperatorData<dim> const & VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
ViscousOperatorData<dim> const & VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
types::global_dof_index VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
  m() const
  {
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
Number VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
MatrixFree<dim,Number> const & VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
  get_data() const
  {
    return *data;
  }
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
unsigned int VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
  get_dof_index() const
  {
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
void VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
  cell_loop_apply_inverse_block_jacobi_matrices (MatrixFree<dim,Number> const                &data,
...
template <int dim, int fe_degree, int fe_degree_xwall, int xwall_quad_rule,typename Number>
MatrixOperatorBaseNew<dim, Number>* VelocityConvDiffOperator<dim, fe_degree, fe_degree_xwall, xwall_quad_rule,Number>::
