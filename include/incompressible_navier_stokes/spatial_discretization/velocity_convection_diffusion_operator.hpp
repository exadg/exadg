...
template class VelocityConvDiffOperator<2, 10, 1, 1, float>;
#endif
#if DIM_2 && DEGREE_10 && (OP_DOUBLE || MG_DOUBLE)
template class VelocityConvDiffOperator<2, 10, 1, 1, double>;
#endif

#if DIM_2 && DEGREE_11 && (OP_FLOAT || MG_FLOAT)
template class VelocityConvDiffOperator<2, 11, 1, 1, float>;
#endif
#if DIM_2 && DEGREE_11 && (OP_DOUBLE || MG_DOUBLE)
template class VelocityConvDiffOperator<2, 11, 1, 1, double>;
#endif

#if DIM_2 && DEGREE_12 && (OP_FLOAT || MG_FLOAT)
template class VelocityConvDiffOperator<2, 12, 1, 1, float>;
#endif
#if DIM_2 && DEGREE_12 && (OP_DOUBLE || MG_DOUBLE)
template class VelocityConvDiffOperator<2, 12, 1, 1, double>;
#endif

#if DIM_2 && DEGREE_13 && (OP_FLOAT || MG_FLOAT)
template class VelocityConvDiffOperator<2, 13, 1, 1, float>;
#endif
#if DIM_2 && DEGREE_13 && (OP_DOUBLE || MG_DOUBLE)
template class VelocityConvDiffOperator<2, 13, 1, 1, double>;
#endif

#if DIM_2 && DEGREE_14 && (OP_FLOAT || MG_FLOAT)
template class VelocityConvDiffOperator<2, 14, 1, 1, float>;
#endif
#if DIM_2 && DEGREE_14 && (OP_DOUBLE || MG_DOUBLE)
template class VelocityConvDiffOperator<2, 14, 1, 1, double>;
#endif

#if DIM_2 && DEGREE_15 && (OP_FLOAT || MG_FLOAT)
template class VelocityConvDiffOperator<2, 15, 1, 1, float>;
#endif
#if DIM_2 && DEGREE_15 && (OP_DOUBLE || MG_DOUBLE)
template class VelocityConvDiffOperator<2, 15, 1, 1, double>;
#endif
...
template class VelocityConvDiffOperator<3, 10, 1, 1, float>;
#endif
#if DIM_3 && DEGREE_10 && (OP_DOUBLE || MG_DOUBLE)
template class VelocityConvDiffOperator<3, 10, 1, 1, double>;
#endif

#if DIM_3 && DEGREE_11 && (OP_FLOAT || MG_FLOAT)
template class VelocityConvDiffOperator<3, 11, 1, 1, float>;
#endif
#if DIM_3 && DEGREE_11 && (OP_DOUBLE || MG_DOUBLE)
template class VelocityConvDiffOperator<3, 11, 1, 1, double>;
#endif

#if DIM_3 && DEGREE_12 && (OP_FLOAT || MG_FLOAT)
template class VelocityConvDiffOperator<3, 12, 1, 1, float>;
#endif
#if DIM_3 && DEGREE_12 && (OP_DOUBLE || MG_DOUBLE)
template class VelocityConvDiffOperator<3, 12, 1, 1, double>;
#endif

#if DIM_3 && DEGREE_13 && (OP_FLOAT || MG_FLOAT)
template class VelocityConvDiffOperator<3, 13, 1, 1, float>;
#endif
#if DIM_3 && DEGREE_13 && (OP_DOUBLE || MG_DOUBLE)
template class VelocityConvDiffOperator<3, 13, 1, 1, double>;
#endif

#if DIM_3 && DEGREE_14 && (OP_FLOAT || MG_FLOAT)
template class VelocityConvDiffOperator<3, 14, 1, 1, float>;
#endif
#if DIM_3 && DEGREE_14 && (OP_DOUBLE || MG_DOUBLE)
template class VelocityConvDiffOperator<3, 14, 1, 1, double>;
#endif

#if DIM_3 && DEGREE_15 && (OP_FLOAT || MG_FLOAT)
template class VelocityConvDiffOperator<3, 15, 1, 1, float>;
#endif
#if DIM_3 && DEGREE_15 && (OP_DOUBLE || MG_DOUBLE)
template class VelocityConvDiffOperator<3, 15, 1, 1, double>;
#endif
