...
public:
  ...
  {
    this->data->loop(&PressureNeumannBCConvectiveTerm<dim, fe_degree_u, fe_degree_p, fe_degree_xwall, xwall_quad_rule, value_type>::local_cell,
                     &PressureNeumannBCConvectiveTerm<dim, fe_degree_u, fe_degree_p, fe_degree_xwall, xwall_quad_rule, value_type>::local_face,
                     &PressureNeumannBCConvectiveTerm<dim, fe_degree_u, fe_degree_p, fe_degree_xwall, xwall_quad_rule, value_type>::local_boundary_face,
                     this, dst, src);
  }
