...
#ifndef INCLUDE_MULTIGRIDPRECONDITIONERLAPLACE_H_
#define INCLUDE_MULTIGRIDPRECONDITIONERLAPLACE_H_


#include "MultigridPreconditionerAdapterBase.h"
...
#endif /* INCLUDE_MULTIGRIDPRECONDITIONERLAPLACE_H_ */
