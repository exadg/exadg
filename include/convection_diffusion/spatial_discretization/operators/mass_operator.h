...
public:
  ...
  typedef OperatorBase<dim, fe_degree, value_type,
                                              MassMatrixOperatorData<dim>> Parent;
...
private:
  ...
  void do_boundary_integral(FEEvalFace &, OperatorType const &, types::boundary_id const &) const{}
