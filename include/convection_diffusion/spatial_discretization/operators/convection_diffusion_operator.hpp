...
template class ConvectionDiffusionOperator<2, 0, float>;
#endif
#if DIM_2 && DEGREE_0 && (OP_DOUBLE || MG_DOUBLE)
template class ConvectionDiffusionOperator<2, 0, double>;
#endif
...
template class ConvectionDiffusionOperator<3, 0, float>;
#endif
#if DIM_3 && DEGREE_0 && (OP_DOUBLE || MG_DOUBLE)
template class ConvectionDiffusionOperator<3, 0, double>;
#endif
