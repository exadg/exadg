...
#ifndef INCLUDE_MULTIGRIDPRECONDITIONERSCALARCONVDIFF_H_
#define INCLUDE_MULTIGRIDPRECONDITIONERSCALARCONVDIFF_H_

#include "MultigridPreconditionerDG.h"

/*
 *  Multigrid preconditioner for (reaction-)diffusion operator
 *  (Helmholtz operator) of the scalar convection-diffusion equation.
 */
template<int dim, typename value_type, typename Operator, typename UnderlyingOperator>
class MyMultigridPreconditionerScalarDiff : public MyMultigridPreconditionerDG<dim,value_type,Operator,UnderlyingOperator>
{
public:
  MyMultigridPreconditionerScalarDiff(){}

  virtual ~MyMultigridPreconditionerScalarDiff(){};
 ...
 *  operator of the scalar convection-diffusion equation.
 */
template<int dim, typename value_type, typename Operator, typename UnderlyingOperator>
class MyMultigridPreconditionerScalarConvDiff : public MyMultigridPreconditionerDG<dim,value_type,Operator,UnderlyingOperator>
{
public:
  MyMultigridPreconditionerScalarConvDiff(){}

  virtual ~MyMultigridPreconditionerScalarConvDiff(){};
...
#endif /* INCLUDE_MULTIGRIDPRECONDITIONERSCALARCONVDIFF_H_ */
