...
template <int dim, int fe_degree_1, int fe_degree_2, typename Number,
          typename VNumber>
MGTransferMatrixFreeP<dim, fe_degree_1, fe_degree_2, Number,
                      VNumber>::MGTransferMatrixFreeP() {}

template <int dim, int fe_degree_1, int fe_degree_2, typename Number,
          typename VNumber>
MGTransferMatrixFreeP<dim, fe_degree_1, fe_degree_2, Number, VNumber>::
...
template <int dim, int fe_degree_1, int fe_degree_2, typename Number,
          typename VNumber>
void MGTransferMatrixFreeP<dim, fe_degree_1, fe_degree_2, Number, VNumber>::
    reinit(const DoFHandler<dim> &dof_handler_1,
           const DoFHandler<dim> &dof_handler_2, const unsigned int level) {
  {
...
template <int dim, int fe_degree_1, int fe_degree_2, typename Number,
          typename VNumber>
void MGTransferMatrixFreeP<dim, fe_degree_1, fe_degree_2, Number,
                           VNumber>::initialize_dof_vector(VNumber &vec_1,
                                                           VNumber &vec_2) {
...
template <int dim, int fe_degree_1, int fe_degree_2, typename Number,
          typename VNumber>
void MGTransferMatrixFreeP<dim, fe_degree_1, fe_degree_2, Number, VNumber>::
    restrict_and_add(const unsigned int /*level*/, VNumber &dst,
                     const VNumber &src) const {
  data_1.cell_loop(&MGTransferMatrixFreeP<dim, fe_degree_1, fe_degree_2, Number,
                                          VNumber>::restrict_and_add_local,
                   this, dst, src);
}
...
template <int dim, int fe_degree_1, int fe_degree_2, typename Number,
          typename VNumber>
void MGTransferMatrixFreeP<dim, fe_degree_1, fe_degree_2, Number,
                           VNumber>::prolongate(const unsigned int /*level*/,
                                                VNumber &dst,
                                                const VNumber &src) const {
  data_1.cell_loop(&MGTransferMatrixFreeP<dim, fe_degree_1, fe_degree_2, Number,
                                          VNumber>::prolongate_local,
                   this, dst, src);
}
...
void MGTransferMatrixFreeP<dim, fe_degree_1, fe_degree_2, Number, VNumber>::
    restrict_and_add_local(
        const MatrixFree<dim, value_type> & /*data*/, VNumber &dst,
        const VNumber &src,
  ...
  AlignedVector<VectorizedArray<Number>> temp1(
      std::max(phi1.n_q_points, phi2.n_q_points));
  AlignedVector<VectorizedArray<Number>> temp2(
      std::max(phi1.n_q_points, phi2.n_q_points));
  ...
  for (unsigned int cell = cell_range.first; cell < cell_range.second; ++cell) {
    ...
    if (dim == 2) {
      ...
      dealii::internal::EvaluatorTensorProduct<
          dealii::internal::evaluate_evenodd, 2, fe_degree_2 + 1,
          fe_degree_1 + 1, VectorizedArray<Number>>
          eval_val(shape_values_prol, shape_values_prol, shape_values_prol);
      eval_val.template values<1, false, false>(phi1.begin_dof_values(),
                                                temp2.begin());
      eval_val.template values<0, false, false>(temp2.begin(), temp1.begin());
    } else {
      // ... 3D
      dealii::internal::EvaluatorTensorProduct<
          dealii::internal::evaluate_evenodd, 3, fe_degree_2 + 1,
          fe_degree_1 + 1, VectorizedArray<Number>>
          eval_val(shape_values_prol, shape_values_prol, shape_values_prol);
      eval_val.template values<2, false, false>(phi1.begin_dof_values(),
                                                temp1.begin());
  ...
  for (unsigned int cell = cell_range.first; cell < cell_range.second; ++cell) {
    ...
    if (dim == 2) {
      ...
      dealii::internal::EvaluatorTensorProduct<
          ...
          fe_degree_1 + 1, VectorizedArray<Number>>
          eval_val(shape_values_prol, shape_values_prol, shape_values_prol);
      eval_val.template values<0, true, false>(phi2.begin_dof_values(),
                                               temp2.begin());
...
void MGTransferMatrixFreeP<dim, fe_degree_1, fe_degree_2, Number, VNumber>::
    convert_to_eo(AlignedVector<VectorizedArray<Number>> &shape_values,
                  ...
                  unsigned int fe_degree, unsigned int n_q_points_1d) {
...
void MGTransferMatrixFreeP<dim, fe_degree_1, fe_degree_2, Number, VNumber>::
    fill_shape_values(AlignedVector<VectorizedArray<Number>> &shape_values,
                      unsigned int fe_degree_src, unsigned int fe_degree_dst) {

  FullMatrix<double> matrix(fe_degree_dst + 1, fe_degree_src + 1);
  FETools::get_projection_matrix(FE_DGQ<1>(fe_degree_src),
                                 FE_DGQ<1>(fe_degree_dst), matrix);
  ...
  convert_to_eo(shape_values_temp, shape_values, fe_degree_src,
                fe_degree_dst + 1);
}
