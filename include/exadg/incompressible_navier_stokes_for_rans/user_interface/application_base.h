...
#ifndef INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_USER_INTERFACE_APPLICATION_BASE_H_
#define INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_USER_INTERFACE_APPLICATION_BASE_H_
...
public:
  ...
  setup_poisson(std::shared_ptr<Grid<dim> const> const & grid)
  {
    ...
    // the grid is created using the parameters specified in IncRANS::Parameters
...
#endif /* INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_USER_INTERFACE_APPLICATION_BASE_H_ */
