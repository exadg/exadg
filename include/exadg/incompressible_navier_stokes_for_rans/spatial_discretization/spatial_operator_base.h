...
#ifndef INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_SPATIAL_DISCRETIZATION_SPATIAL_OPERATOR_BASE_H_
#define INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_SPATIAL_DISCRETIZATION_SPATIAL_OPERATOR_BASE_H_
...
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/calculators/streamfunction_calculator_rhs_operator.h>
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/generalized_newtonian_model.h>
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/operators/convective_operator.h>
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/operators/divergence_operator.h>
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/operators/gradient_operator.h>
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/operators/momentum_operator.h>
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/operators/projection_operator.h>
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/operators/rhs_operator.h>
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/operators/viscous_operator.h>
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/turbulence_model.h>
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/viscosity_model_base.h>
...
#include <exadg/operators/rans_operator.h>
...
#endif /* INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_SPATIAL_DISCRETIZATION_SPATIAL_OPERATOR_BASE_H_ \
        */
