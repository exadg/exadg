...
#ifndef INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_SPATIAL_DISCRETIZATION_OPERATOR_DUAL_SPLITTING_H_
#define INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_SPATIAL_DISCRETIZATION_OPERATOR_DUAL_SPLITTING_H_

// base class
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/curl_compute.h>
#include <exadg/incompressible_navier_stokes_for_rans/spatial_discretization/operator_projection_methods.h>
...
#endif /* INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_SPATIAL_DISCRETIZATION_OPERATOR_DUAL_SPLITTING_H_ \
        */
