...
private:
  ...
  std::shared_ptr<RANS::CombinedOperator<dim, Number>> pressure_conv_diff_operator;
...
#endif /* INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_SPATIAL_DISCRETIZATION_OPERATOR_COUPLED_H_ \
        */
