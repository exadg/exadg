...
#ifndef INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_DRIVER_H_
#define INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_DRIVER_H_
...
//       convective term (explicit/implicit), e.g., specifying VelocityRANSOperator together
...
enum class OperatorType{
  ...
  VelocityRANSOperator, // mass + convective + viscous (vectorial quantity, velocity)
                     ...
                     ExaDG::ElementType const element_type)
{
  ...
  // velocity only
          ...
          operator_type == OperatorType::VelocityRANSOperator or
...
#endif /* INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_DRIVER_H_ */
