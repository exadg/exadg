...
#ifndef INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_SOLVER_H_
#define INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_SOLVER_H_
    ...
    bool const          is_test)
{
  ...
  std::shared_ptr<IncRANS::Driver<dim, Number>> driver =
    std::make_shared<IncRANS::Driver<dim, Number>>(mpi_comm, application, is_test, false);
...
#endif /* INCLUDE_EXADG_INCOMPRESSIBLE_NAVIER_STOKES_FOR_RANS_SOLVER_H_ */
