                             ...
                             std::shared_ptr<MatrixFreeData<dim, Number>>     matrix_free_data_in)
{
  ...
  {
    interface_data_dirichlet_cached = std::make_shared<ContainerInterfaceData<1, dim>>();
  ...
  {
    interface_data_neumann_cached = std::make_shared<ContainerInterfaceData<1, dim>>();
    std::vector<unsigned int> quad_indices;
