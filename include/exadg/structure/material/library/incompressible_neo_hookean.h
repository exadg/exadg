...
#ifndef EXADG_STRUCTURE_MATERIAL_LIBRARY_INCOMPRESSIBLE_NEO_HOOKEAN_H_
#define EXADG_STRUCTURE_MATERIAL_LIBRARY_INCOMPRESSIBLE_NEO_HOOKEAN_H_
...
private:
  ...
  Number static constexpr one_third = 1.0 / 3.0;
};
} // namespace Structure
} // namespace ExaDG

#endif /* EXADG_STRUCTURE_MATERIAL_LIBRARY_INCOMPRESSIBLE_NEO_HOOKEAN_H_ */
