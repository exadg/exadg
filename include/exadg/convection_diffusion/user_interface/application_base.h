...
#ifndef EXADG_CONVECTION_DIFFUSION_USER_INTERFACE_APPLICATION_BASE_H_
#define EXADG_CONVECTION_DIFFUSION_USER_INTERFACE_APPLICATION_BASE_H_
...
#endif /* EXADG_CONVECTION_DIFFUSION_USER_INTERFACE_APPLICATION_BASE_H_ */
