...
Parameters::Parameters()
  : // MATHEMATICAL MODEL
    ...
    solver_data_block_diagonal(SolverData(1000, 1.e-12, 1.e-2, "undefined", 1000)),
    ...
    solver_data_pressure_poisson(SolverData(1e4, 1.e-12, 1.e-6, "cg", 100)),
    ...
    // projection step
    solver_data_projection(SolverData(1000, 1.e-12, 1.e-6, "cg", 100)),
    ...
    solver_data_block_diagonal_projection(SolverData(1000, 1.e-12, 1.e-2, "undefined", 1000)),

    // momentum step
    newton_solver_data_momentum(Newton::SolverData(1e2, 1.e-12, 1.e-6)),
    solver_data_momentum(SolverData(1e4, 1.e-12, 1.e-6, "gmres", 100)),
    ...
    // linear solver
    solver_data_coupled(SolverData(1e4, 1.e-12, 1.e-6, "gmres", 100)),
    ...
    solver_data_velocity_block(SolverData(1e4, 1.e-12, 1.e-6, "fgmres", 100)),
    ...
    solver_data_pressure_block(SolverData(1e4, 1.e-12, 1.e-6, "cg", 100))
{
}
