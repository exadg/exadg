...
#ifndef INCLUDE_EXADG_RANS_EQUATIONS_SOLVER_H_
#define INCLUDE_EXADG_RANS_EQUATIONS_SOLVER_H_
    ...
    bool const          is_test)
{
  ...
  std::shared_ptr<RANS::Driver<dim, Number>> driver =
    std::make_shared<RANS::Driver<dim, Number>>(mpi_comm, application, is_test, false);
...
#endif /* INCLUDE_EXADG_RANS_EQUATIONS_SOLVER_H_ */
