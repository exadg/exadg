                                                 ...
                                                 IntegratorFace & integrator_p) const
{
  for(unsigned int q = 0; q < integrator_m.n_q_points; ++q)
  {
    ...
    scalar gradient_flux = kernel->calculate_gradient_flux(value_m, value_p, q);
    ...
    scalar value_flux =
      kernel->calculate_value_flux(normal_gradient_m, normal_gradient_p, value_m, value_p, q);
                                                     ...
                                                     IntegratorFace & integrator_p) const
{
  ...
  for(unsigned int q = 0; q < integrator_p.n_q_points; ++q)
  {
    ...
    scalar gradient_flux = kernel->calculate_gradient_flux(value_p, value_m, q);
    ...
    scalar value_flux =
      kernel->calculate_value_flux(normal_gradient_p, normal_gradient_m, value_p, value_m, q);
  ...
  dealii::types::boundary_id const & boundary_id) const
{
  ...
  for(unsigned int q = 0; q < integrator_m.n_q_points; ++q)
  {
    ...
    scalar gradient_flux = kernel->calculate_boundary_gradient_flux(value_m, value_p, q);
    ...
    scalar value_flux =
      kernel->calculate_boundary_value_flux(normal_gradient_m, normal_gradient_p, value_m, value_p, q);
