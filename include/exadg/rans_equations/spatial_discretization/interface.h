...
#ifndef INCLUDE_EXADG_RANS_EQUATIONS_SPATIAL_DISCRETIZATION_INTERFACE_H_
#define INCLUDE_EXADG_RANS_EQUATIONS_SPATIAL_DISCRETIZATION_INTERFACE_H_
...
private:
  std::shared_ptr<RANS::Interface::Operator<Number>> pde_operator;
...
#endif /* INCLUDE_EXADG_RANS_EQUATIONS_SPATIAL_DISCRETIZATION_INTERFACE_H_ */
