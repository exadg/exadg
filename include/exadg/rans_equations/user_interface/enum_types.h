...
#ifndef INCLUDE_EXADG_RANS_EQUATIONS_USER_INTERFACE_ENUM_TYPES_H_
#define INCLUDE_EXADG_RANS_EQUATIONS_USER_INTERFACE_ENUM_TYPES_H_
...
#endif /* INCLUDE_EXADG_RANS_EQUATIONS_USER_INTERFACE_ENUM_TYPES_H_ */
