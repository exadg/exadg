...
#ifndef EXADG_OPERATORS_BOUNDARY_MASS_KERNEL_H_
#define EXADG_OPERATORS_BOUNDARY_MASS_KERNEL_H_
...
public:
  ...
  inline DEAL_II_ALWAYS_INLINE //
    T
    get_boundary_mass_normal_value(Number coefficient, vector const & normal, T const & value) const
  {
  ...
  inline DEAL_II_ALWAYS_INLINE //
    T
    get_boundary_mass_value(Number coefficient, T const & value) const
  {
...
#endif /* EXADG_OPERATORS_BOUNDARY_MASS_KERNEL_H_ */
