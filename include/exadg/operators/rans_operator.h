...
#ifndef INCLUDE_EXADG_OPERATORS_NAVIER_STOKES_FOR_RANS_CALCULATORS_H_
#define INCLUDE_EXADG_OPERATORS_NAVIER_STOKES_FOR_RANS_CALCULATORS_H_
...
private:
  ...
  IncRANS::Operators::ViscousKernel<dim, Number> const * viscous_kernel;
};
...
#endif /* INCLUDE_EXADG_OPERATORS_NAVIER_STOKES_FOR_RANS_CALCULATORS_H_ \
        */
