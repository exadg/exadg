...
#ifndef INCLUDE_EXADG_OPERATORS_SOLUTION_PROJECTION_BETWEEN_TRIANGULATIONS_H
#define INCLUDE_EXADG_OPERATORS_SOLUTION_PROJECTION_BETWEEN_TRIANGULATIONS_H
...
{
// Preconditioner used for the potentially global projection.
...
struct GridToGridProjectionData
{
  GridToGridProjectionData()
    : rpe_data(),
      solver_data(),
      preconditioner(Preconditioner::PointJacobi),
 ...
 * `dealii::FiniteElement` per `dealii::DoFHandler`.
 */
...
#endif /* INCLUDE_EXADG_OPERATORS_SOLUTION_PROJECTION_BETWEEN_TRIANGULATIONS_H */
