 ...
 *  and a specified number of refinements, where the time step size is reduced by
 *  a factor of 2 for each refinement level.
 */
...
/*
 *  This function calculates the time step such that the spatial and temporal errors
