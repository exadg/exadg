...
public:
   ...
   */
  virtual void
  output_solution(const std::string filename_base, const unsigned int n_subdivisions = 0) const;

  void
  compute_vorticity() const;
...
private:
  void
  apply_inhomogeneous_velocity_boundary_conditions(
