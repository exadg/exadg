...
#ifndef APPLICATIONS_NAVIERSTOKESTESTCASES_STOKESGUERMOND_H_
#define APPLICATIONS_NAVIERSTOKESTESTCASES_STOKESGUERMOND_H_
...
unsigned int const REFINE_STEPS_SPACE_MAX = 7; //REFINE_STEPS_SPACE_MIN;
