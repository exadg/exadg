...
private:
  ...
  std::shared_ptr<DGNavierStokesPressureCorrection<dim, fe_degree_u, fe_degree_p, fe_degree_xwall, xwall_quad_rule, Number> > navier_stokes_operation;

  std::shared_ptr<PostProcessorBase<dim,Number> > postprocessor;

  std::shared_ptr<TimeIntBDFNavierStokes<dim, fe_degree_u, Number,
    DGNavierStokesPressureCorrection<dim, fe_degree_u, fe_degree_p, fe_degree_xwall, xwall_quad_rule, Number> > > time_integrator;
};
  ...
  n_refine_space(refine_steps_space)
{
  ...
  navier_stokes_operation.reset(new DGNavierStokesPressureCorrection<dim, fe_degree_u, fe_degree_p, fe_degree_xwall, xwall_quad_rule, Number>
      (triangulation,param));
  ...
  time_integrator.reset(new TimeIntBDFPressureCorrection<dim, fe_degree_u, Number, DGNavierStokesPressureCorrection<dim, fe_degree_u, fe_degree_p, fe_degree_xwall, xwall_quad_rule, Number> >(
