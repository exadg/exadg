...
void InputParameters<dim>::set_input_parameters()
{
  ...
  preconditioner_momentum = MomentumPreconditioner::InverseMassMatrix; //InverseMassMatrix;
  ...
  multigrid_data_momentum.coarse_solver = MultigridCoarseGridSolver::GMRES_NoPreconditioner; //Chebyshev;
