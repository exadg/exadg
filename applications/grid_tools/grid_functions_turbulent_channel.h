...
#ifndef APPLICATIONS_GRID_TOOLS_GRID_FUNCTIONS_TURBULENT_CHANNEL_H_
#define APPLICATIONS_GRID_TOOLS_GRID_FUNCTIONS_TURBULENT_CHANNEL_H_
...
#endif /* APPLICATIONS_GRID_TOOLS_GRID_FUNCTIONS_TURBULENT_CHANNEL_H_ */
