...
#ifndef APPLICATIONS_INCOMPRESSIBLE_NAVIER_STOKES_ALE_TEST_CASES_VORTEX_H_
#define APPLICATIONS_INCOMPRESSIBLE_NAVIER_STOKES_ALE_TEST_CASES_VORTEX_H_
...
set_input_parameters(InputParameters & param)
{
  ...
  //  PreconditionerGMRESSmoother::BlockJacobi;
...
template<int dim>
void
set_field_functions(std::shared_ptr<FieldFunctions<dim>> field_functions, InputParameters param_in)
{
...
#endif /* APPLICATIONS_INCOMPRESSIBLE_NAVIER_STOKES_ALE_TEST_CASES_VORTEX_H_ */
