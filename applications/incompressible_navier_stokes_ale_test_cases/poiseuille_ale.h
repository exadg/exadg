...
#ifndef APPLICATIONS_INCOMPRESSIBLE_NAVIER_STOKES_ALE_TEST_CASES_POISEUILLE_H_
...
void set_input_parameters(InputParameters &param)
{
  ...
  param.preconditioner_velocity_block = MomentumPreconditioner::PointJacobi;
...
#endif /* APPLICATIONS_INCOMPRESSIBLE_NAVIER_STOKES_ALE_TEST_CASES_POISEUILLE_H_ */
