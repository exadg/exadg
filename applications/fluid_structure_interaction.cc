...
main(int argc, char ** argv)
{
  ...
  if(argc == 1)
  {
    ...
    {
      // clang-format off
      std::cout << "To run the program, use:      ./fluid_structure_interaction input_file" << std::endl
                << "To setup the input file, use: ./fluid_structure_interaction input_file --help" << std::endl;
      // clang-format on
    }
