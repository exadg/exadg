...
#ifndef APPLICATIONS_CONVECTION_DIFFUSION_TEST_CASES_DIFFUSIVE_PROBLEM_HOMOGENEOUS_DBC_H_
#define APPLICATIONS_CONVECTION_DIFFUSION_TEST_CASES_DIFFUSIVE_PROBLEM_HOMOGENEOUS_DBC_H_
...
void InputParametersConvDiff::set_input_parameters()
{
  ...
  output_data.output_folder = "output_conv_diff/diffusive_problem_homogeneous_DBC/";
  output_data.output_name = "diffusive_problem_homogeneous_DBC";
...
#endif /* APPLICATIONS_CONVECTION_DIFFUSION_TEST_CASES_DIFFUSIVE_PROBLEM_HOMOGENEOUS_DBC_H_ */
