/*
 * DiffusiveProblemHomogeneousNBC.h
 *
 *  Created on: Aug 18, 2016
 *      Author: fehn
 */

#ifndef APPLICATIONS_CONVECTION_DIFFUSION_TEST_CASES_DIFFUSIVE_PROBLEM_HOMOGENEOUS_NBC_H_
#define APPLICATIONS_CONVECTION_DIFFUSION_TEST_CASES_DIFFUSIVE_PROBLEM_HOMOGENEOUS_NBC_H_
...
// prescribe analytical solution and choose right hand side f
// such that the residual is equal to zero
...
void InputParametersConvDiff::set_input_parameters()
{
  ...
  calculation_of_time_step_size = TimeStepCalculation::ConstTimeStepUserSpecified; //ConstTimeStepDiffusion;
  ...
  output_data.output_folder = "output_conv_diff/diffusive_problem_homogeneous_NBC/";
  output_data.output_name = "diffusive_problem_homogeneous_NBC";
...
#endif /* APPLICATIONS_CONVECTION_DIFFUSION_TEST_CASES_DIFFUSIVE_PROBLEM_HOMOGENEOUS_NBC_H_ */
