    ...
    MPI_Comm const &        mpi_comm)
{
  ...
  driver->setup(application, degree, refine_space, 0 /* refine time */);
...
main(int argc, char ** argv)
{
  ...
  // ./elasticity_throughput --help NameOfApplication
  ...
  study.fill_resolution_vector(&Structure::get_dofs_per_element, throughput.operator_type);
