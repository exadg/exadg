...
private:
  ...
  set_parameters() final
  {
    ...
    this->param.solver_data_pressure_poisson    = SolverData(1000, 1.e-20, 1.e-6, "cg", 100);
    this->param.preconditioner_pressure_poisson = PreconditionerPressurePoisson::Multigrid;

    // projection step
    this->param.solver_data_projection    = SolverData(1000, 1.e-20, 1.e-12, "cg");
    ...
    {
      this->param.solver_data_momentum             = SolverData(1000, 1.e-20, 1.e-6, "cg");
    ...
    if(this->param.temporal_discretization == TemporalDiscretization::BDFPressureCorrection)
    {
      ...
      // linear solver
      this->param.solver_data_momentum           = SolverData(1e4, 1.e-20, 1.e-4, "gmres", 100);
    ...
    // linear solver
    this->param.solver_data_coupled = SolverData(1e4, 1.e-12, 1.e-3, "fgmres", 1000);
