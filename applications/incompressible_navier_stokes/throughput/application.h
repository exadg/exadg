...
private:
  ...
  set_parameters() final
  {
    ...
    this->param.solver_data_pressure_poisson.solver_name = "cg";
    this->param.preconditioner_pressure_poisson          = PreconditionerPressurePoisson::None;

    // projection step
    this->param.solver_data_projection.solver_name = "cg";
    ...
    {
      this->param.solver_data_momentum.solver_name = "cg";
    ...
    {
      // linear solver
      this->param.solver_data_momentum.solver_name = "gmres";
      this->param.preconditioner_momentum          = MomentumPreconditioner::None;
    }
    ...
    // linear solver
    this->param.solver_data_coupled.solver_name = "gmres";
