...
public:
  ...
  run()
  {
    ...
    if(use_dg)
      ...
      fe_u_1.reset(new FESystem<dim>(FE_Q<dim>(fe_degree_1), dim));
    ...
    if(use_dg)
      fe_u_2.reset(new FESystem<dim>(FE_DGQ<dim>(fe_degree_2), dim));
    else
    ...
    MGTransferMFP<dim, value_type, VectorType, dim> transfer(&data_1,
                                                             &data_2,
                                                             fe_degree_1,
                                                             fe_degree_2);
