...
const int n_global_refinements = 3;
...
private:
    ...
    void run_1() {
        ...
        VectorTools::interpolate(dof_handler_dg, ExactSolution<dim>(), vector_dg);
        ...
        convergence_table.add_value("test1_norm", norm_cg);
    ...
    void run_2() {
        ...
        VectorTools::interpolate(dof_handler_cg, ExactSolution<dim>(), vector_cg);
