...
class OperatorWrapperIcomConvectiveOperator : public OperatorWrapperIcomp<dim, degree_u, degree_p, Number>
{
    
    typedef OperatorWrapperIcomp<dim, degree_u, degree_p, Number> PARENT;
    
public:
  OperatorWrapperIcomConvectiveOperator(parallel::distributed::Triangulation<dim> const & triangulation)
...
template<int dim, int degree_u, int degree_p, typename Number>
class OperatorWrapperIcomViscousOperator : public OperatorWrapperIcomp<dim, degree_u, degree_p, Number>
{
    
    typedef OperatorWrapperIcomp<dim, degree_u, degree_p, Number> PARENT;
    
public:
  OperatorWrapperIcomViscousOperator(parallel::distributed::Triangulation<dim> const & triangulation)
    : OperatorWrapperIcomp<dim, degree_u, degree_p, Number>(triangulation)
  {
