...
class OperatorWrapperIcompMassMatrix : public OperatorWrapper
{
...
public:
      ...
      dof_handler_u_scalar(triangulation)
  {
    ...
    this->data.initialize_dof_vector(dst, dof_index_u);
    //mass_matrix_operator.initialize_dof_vector(src);
    //mass_matrix_operator.initialize_dof_vector(dst);
  }
