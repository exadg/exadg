...
main(int argc, char * argv[])
{
  try
  {
    ...
    std::string const json_folder =
      "../../../../../tests/restart/json_files_acoustic_conservation_equations/";
...
// application
#include "../applications/acoustic_conservation_equations/circular_moving_gauss_pulse/application.h"
