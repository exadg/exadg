...
main(int argc, char * argv[])
{
  try
  {
    ...
    std::string const json_folder = "../../../../../tests/restart/json_files_convection_diffusion/";

    // define *pairs of* reference and restart files
    std::vector<std::string> const reference_files = {
      "input_reference_read_write_mapping_N.json",
      "input_reference_read_write_mapping_Y.json",
      "input_reference_read_write_mapping_Y_explicit.json"};
    std::vector<std::string> const restart_files = {
      "input_restart_read_write_mapping_N.json",
      "input_restart_read_write_mapping_Y.json",
      "input_restart_read_write_mapping_Y_explicit.json"};
...
// application
#include "../applications/convection_diffusion/rotating_hill/application.h"
