...
Please keep in mind that multiple small patches are easier reviewed than a single larger one. Consider grouping your changes into bite-size pieces, say, 1000 new or changed lines or less. For larger projects, discussing possible routes with the principal developers might be useful to synchronize ideas upfront and streamline code development.
...
We also want to encourage you grouping your patch into few commits and rebasing your branch onto the latest master commit before the PR is merged.
